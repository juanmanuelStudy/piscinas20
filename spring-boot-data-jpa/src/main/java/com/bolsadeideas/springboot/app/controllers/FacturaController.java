...
Pageable pageRequest = PageRequest.of(page, 10);
 ...
 PageRender<Factura> pageRender = new PageRender<Factura>("/factura/listarFactura", factura);

 //captura la candidad buscada en el filtro
 	model.addAttribute("cantidad",clienteService.findByClienteAndProveedorAndLugarAndEmviadoN(desde,hasta,cliente, proveedor, lugar, pageRequest).getNumberOfElements());
 	
 	log.info("cantidad encontrada  N :"+clienteService.findByClienteAndProveedorAndLugarAndEmviadoN(desde,hasta,cliente, proveedor, lugar, pageRequest).getNumberOfElements());
